...
BOT_TOKEN = environ.get('BOT_TOKEN', "8303417881:AAEz0w0UuiCcdk17eGIQbgBLeQqnqXFEoMc")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003125295677'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003125295677').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003125295677')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ravi:9481851889@cluster0.tnzruhu.mongodb.net/?retryWrites=true&w=majority")
...
AUTO_FFILTER = bool(environ.get('AUTO_FILTER', True))
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', '[https://kalinks.in](https://kalinks.in)')
SHORTLINK_API = environ.get('SHORTLINK_API', 'c5f50c2b94f8489775d29a6c03f777c4459cc4e5')
